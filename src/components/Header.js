...
/* Generowanie nagłówka z menu na stronie głównej */
class Header extends Component {
            ...
            <div className="container">
              ...
              <div className="mobile-menu">
                <nav className="main-menu">
                  <a onClick={this.handleClick} className="scroll" data-link="#about">
                    <Trans>O nas</Trans>
                  </a>
                  <a onClick={this.handleClick} className="scroll" data-link="#investments">
                    <Trans>Investycje</Trans>
                  </a>
                  <a onClick={this.handleClick} className="scroll" data-link="#credit">
                    <Trans>Kredyty</Trans>
                  </a>
                  <a onClick={this.handleClick} className="scroll" data-link="#team">
                    <Trans>Nasz Zespół</Trans>
                  </a>
                  <a onClick={this.handleClick} className="scroll" data-link="#contact">
                    <Trans>Kontakt</Trans>
                  </a>
                  {/* Element zmiany języka w menu */}
                  {/* <a onClick={this.handleClick} className="lang"></a>  */}
                </nav>
              </div>
            </div>
          </header></div>
  ...
  /* Rozwinięcie menu mobilnego i zmiana wyglądu przycisku dla rozdzielczości mniejszej niż 767px */
  handleClick(e) {
